...
<title>Turismo Aventura</title>
  <nav class="navbar navbar-expand-lg bg-body-tertiary" id="navPrincipal">
    <div class="container-fluid"  id="containerPrincipal">
      <a class="navbar-nav" href="https://turismoaventura.com.br/MasterFrameSet.php"><img src="https://turismoaventura.com.br/img/LogoTurismo.png" id="imgLogo"   alt=""></a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="https://turismoaventura.com.br/pages/pacostes.php">Pacotes</a>
            </li>
            <li class="nav-item">
              <a class="nav-link"></a>
            </li>
              ...
              ?>
                <div class="Passagem">
                    <div class="header-Passagem">
                      ...
                      <div class="row">
                        <div class="col-md-2" align="center">
                          <div class="checkbox-wrapper">
                            ...
                            <input type="checkbox" name="checkViagem<?php echo $index; ?>" data-index="<?php echo $index; ?>" id="Checkbox-Viagem<?php echo $index; ?>" value="viagem<?php echo $index; ?>">                                                
                      ...
                      <div class="col-md-2" align="center" >
                        <svg xmlns="http://www.w3.org/2000/svg" id="IconDelete" width="30" height="30" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                    ...
                    <div class="main-Passagem"></div>
                      <input type="hidden" name="nome_viagem[]" value="<?php echo $row['nome_viagem']; ?>">
                      <input type="hidden" name="data_ida[]" value="<?php echo $row['data_ida']; ?>">
                      <input type="hidden" name="numero_assento[]" value="<?php echo $row['numero_assento']; ?>">
                    </div>
                    <br>
                <?php
                ...
                <div class="modal-footer" style="padding-right: 3%">
                    ...
                    <button type="button" class="btn" name="btnFinaliza" id="btnFinaliza" style="background-color: #1b71ea; color: white" onclick="validarFormulario()">
