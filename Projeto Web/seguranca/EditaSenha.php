...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
	  ...
	  ?>
<main style="text-transform:uppercase;">
	<form name="form1" id="form1"  method="post" action="editaSen.php"class="form-horizontal" autocomplete="off">
    <script>
	...
	<div class="translateMultClass" style="visibility:hidden" id="div08" hidden>Senha alterada com succeso!</div>
		...
		<div class="container">
            ...
            <p id="Att" style="text-align: center;color:red;text-transform:uppercase;">Sua senha deve ser uma combinação de letras maiúsculas, minúsculas,<br> números e caracteres especiais,e devem ter pelo menos de 8 a 12 caracteres. </p>
			...
			<div class="row">
				...
				<label class="col-sm-3">
					<input name="pwsConfirm" type="password" autocomplete="off" class="form-control input-sm" id="pwsConfirm" onFocus="this.value='';" onKeyDown="t123('Button1')" maxlength="15"/>
				</label>
			</div>
