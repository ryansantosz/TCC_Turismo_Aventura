...
<html>
    ...
    <body>
        <div class="panel-heading1">
            <h3>
                <center><label>INSERIR USUARIO</label></center>
            </h3> 
        </div>
        <script>
            function InsereUser(){
                ...
                <div class="content">
                    <div class="panel-body" style="padding: 3rem; background-color: #fff; border: 1px solid #cfcfcf; border-radius: 8px 8px; width: 100%!important; box-shadow: 0px 10px 30px -3px rgba(0,0,0,0.1);">
                        <div class="row">
                            <div class="col-md-4">
                                <label>E-mail</label>
                                <input type="text" class="formInpt" name="txtEmail" id="txtEmail" onchange="ValidaEmail(this);" value="">
                            </div>
                            <div class="col-md-4">
                                <label>Nome</label>
                                <input type="text" class="formInpt" onkeypress="return permitirSomenteLetras(event)" name="txtNome" id="txtNome" value="">
                            </div>
                            <div class="col-md-4">
                                <label>Sobrenome</label>
                                <input type="text" class="formInpt" onkeypress="return permitirSomenteLetras(event)" name="txtSobrenome" id="txtSobrenome" value="">
                            </div>
                        </div>
                        <br><br>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="formInpt" name="txtTelefone" id="txtTelefone" onkeypress="mascara(this, telefone)" maxlength="15" value="">
                            </div>
                            <div class="col-md-4">
                                <label>Status</label>
                        ...
                        <div class="row">
                            <div class="col-md-12" style="text-align-last: center;">
                                <input type="button" id="btnAtualizarDados" class="btnAtualiza" value="INSERIR DADOS" onclick="InsereUser()">
                            </div>
                        </div>
                    </div>
                </div>
