...
<head>
    ...
    <link rel="stylesheet" href="/css/ChamaAparecida.css">
...
<body>
  ...
  <form id="frmViagem" name="frmViagem" method="POST">
      <div class="container">
        ...
        <div class="row">
        <div class="col-md-12">
          <h1 style="font-size: 3rem">Aparecida do Norte</h1>
        </div>
          ...
          <div class="row">
            <div class="col-md-7">
              <div id="carouselExampleIndicators" class="carousel slide">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="../img/aparecida1.png"  alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="../img/aparecida2.png"  alt="..." >
                  </div>
                  <div class="carousel-item">
                    <img src="../img/aparecida3.png"  alt="...">
                  </div>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="input-with-icon" style="padding-left: 29%;">
                        <span style="font-size: 15px; color:#706c6c"><b id="EscolhaIngresso">Escolha aqui</b> o seu ingresso</span>
              ...
              <div class="row">
                <div class="col-md-7">
                  <h4 style="text-align: center;">Sinopse</h4>
                  <span>Aparecida do Norte, cidade do interior de São Paulo, Brasil, é reconhecida como um crucial centro religioso. Destaca-se pela imponente Basílica de Nossa Senhora Aparecida, o maior santuário mariano do mundo e o segundo maior templo católico global. Milhões de fiéis anualmente prestam homenagens à padroeira do Brasil, Nossa Senhora Aparecida. Além do santuário, a cidade oferece pontos turísticos como a Passarela da Fé, que conecta a Basílica à antiga estação ferroviária, o Porto Itaguaçu, local do achado da imagem de Nossa Senhora Aparecida, e o Memorial da Devoção, narrando a história da devoção mariana no Brasil. Aparecida do Norte é um essencial destino de turismo religioso no Brasil, atraindo visitantes de todo o país e do mundo.</span> 
                </div>
...
function AjaxInsereCarrinho(GuardaTodosValor,GuardaValorKid,GuardaValorAdulto,GuardaValorIdoso,qndtTotalIngresso, checkboxValues, GuardaDate, quantidadeKid, quantidadeAdult, quantidadeSr) {
  ...
  $.ajax({
    type: 'POST',
    url: "../Ajax/AjaxInsereCarrinhoAparecida.php",
    data: formdata,
    processData: false,
    contentType: false,
