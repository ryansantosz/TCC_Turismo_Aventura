...
<head>
    ...
    <link rel="stylesheet" href="/css/ChamaSantos.css">
...
<form id="frmViagem" name="frmViagem" method="POST">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6"><h1 style="font-size: 3.5rem">SANTOS</h1></div>
    ...
    <div class="row">
        ...
        <div id="carouselExampleIndicators" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="../img/praiasantos10.png"  alt="...">
            </div>
            <div class="carousel-item">
              <img src="../img/praiasantos14.png"  alt="..." >
            </div>
            <div class="carousel-item">
                <img src="../img/praiasantos13.png" id="santoscoracao" alt="...">
              </div>
          </div>
      ...
      <div class="col-md-5">
          ...
          <div class="row">
            <div class="col-md-6" style="display:end; justify-content: space-between;" >
                <div class="input-with-icon">
                  <span style="font-size: 15px; color:#706c6c"><b id="EscolhaAgenda">Escolha aqui </b>a melhor data para você</span>
                  <i class="fa fa-calendar" aria-hidden="true" id="iconagenda"></i><!-- Substitua "fa-icon" pelo nome do ícone que você deseja usar -->
                </div>
            </div>  
            <div class="col-md-6">
              <div class="input-with-icon" style="padding-left: 29%;">
                <span style="font-size: 15px; color:#706c6c"><b id="EscollhaIngresso">Escolha aqui</b> o seu ingresso</span>
                <i class="fa fa-ticket" aria-hidden="true" id="iconticket" onclick="meuCliqueIngresso();"></i><!-- Substitua "fa-icon" pelo nome do ícone que você deseja usar -->
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-7">
            <h3 style="text-align: center;">Sinopse</h3>
            <span >Santos é uma cidade localizada no litoral do estado de São Paulo, Brasil. Conhecida por suas belas praias, a cidade possui cerca de 7 km de extensão de costa, com diversos trechos de areias brancas e mar azul. As praias mais famosas de Santos são a Praia do Gonzaga, Praia do Boqueirão, Praia do Embaré, Praia do José Menino, Praia do Itararé e Praia da Aparecida. Além de suas praias, Santos também conta com diversos pontos turísticos, como o Aquário Municipal, o Orquidário Municipal, o Jardim Botânico Chico Mendes, o Museu do Café, entre outros. A cidade é bastante movimentada durante o verão, recebendo turistas de diversas partes do Brasil e do mundo. 
            </span>
          </div>
          ...
          <div class="col-md-2" style="padding-right:1%">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 24" style="fill: #21366B;;transform: ;msFilter:;"><circle cx="9" cy="4" r="2"></circle><path d="M16.98 14.804A1 1 0 0 0 16 14h-4.133l-.429-3H16V9h-4.847l-.163-1.142A1 1 0 0 0 10 7H9a1.003 1.003 0 0 0-.99 1.142l.877 6.142A2.009 2.009 0 0 0 10.867 16h4.313l.839 4.196c.094.467.504.804.981.804h3v-2h-2.181l-.839-4.196z"></path><path d="M12.51 17.5c-.739 1.476-2.25 2.5-4.01 2.5A4.505 4.505 0 0 1 4 15.5a4.503 4.503 0 0 1 2.817-4.167l-.289-2.025C3.905 10.145 2 12.604 2 15.5 2 19.084 4.916 22 8.5 22a6.497 6.497 0 0 0 5.545-3.126l-.274-1.374H12.51z"></path></svg>
            <span>Cadeirante</span><br>
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" style="fill: #21366B;;transform: ;msFilter:;"><circle cx="12" cy="6" r="2"></circle><path d="M14 9h-4a1 1 0 0 0-.8.4l-3 4 1.6 1.2L9 13v7h2v-4h2v4h2v-7l1.2 1.6 1.6-1.2-3-4A1 1 0 0 0 14 9z"></path></svg>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            </svg><span style="padding-left: 1%; font-size: 20px;">Guia</span><br><br>
            ...
            <span style="padding-left: 4%; color:#706c6c">Consulte a nossa agenda e veja o melhor pra você.</span><br><br>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" style="fill: #1d1b1b;;transform: ;msFilter:;"><circle cx="9" cy="4" r="2"></circle><path d="M16.98 14.804A1 1 0 0 0 16 14h-4.133l-.429-3H16V9h-4.847l-.163-1.142A1 1 0 0 0 10 7H9a1.003 1.003 0 0 0-.99 1.142l.877 6.142A2.009 2.009 0 0 0 10.867 16h4.313l.839 4.196c.094.467.504.804.981.804h3v-2h-2.181l-.839-4.196z"></path><path d="M12.51 17.5c-.739 1.476-2.25 2.5-4.01 2.5A4.505 4.505 0 0 1 4 15.5a4.503 4.503 0 0 1 2.817-4.167l-.289-2.025C3.905 10.145 2 12.604 2 15.5 2 19.084 4.916 22 8.5 22a6.497 6.497 0 0 0 5.545-3.126l-.274-1.374H12.51z"></path></svg>
            ...
            <br><br>
            <span style=" font-size: 18px; color:#706c6c">º Não oferecemos alimentos.</span>
            <hr>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <i class="fa fa-clock-o" aria-hidden="true" id="iconclock"></i><span style="padding-left: 5px;">30 dias para pedir reembolso</span><br>
          </div>
          <div class="col-md-6">
            <i class="fa fa-lock" aria-hidden="true" id="iconblock" style="padding-left: 39%;"></i><span style="padding-left: 4px;">Pagamentos Criptografados e Seguros</span>
          </div>
        </div>
        <br>
        <span>Ao finalizar a compra, você concorda com nossos <b>Termos de Serviço</b>. Processaremos seus dados pessoais para a conclusão de seu pedido e para outros fins de acordo com nossa <b>Política de Privacidade</b>. Você pode cancelar pagamentos recorrentes a qualquer momento.</span>
        <br>
        <br>
        <br>
        </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="exampleModalLabel"><strong>Tipo de Ingresso</strong></h1>
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <span>(Idade 2-17)</span>
                    </div>
                    <div class="col-md-6" style="padding-left: 12%; padding-top: 5%; display:flex; justify-content: space-between;">
                      <i class="fa fa-minus" aria-hidden="true" id="ExcluiIngressoKid"></i>
                      <div style="width:30%">
                        <input class="form-control" type="number" name="numIngressoKid" id="numIngressoKid" value="0">
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6" style="padding-left: 12%; padding-top: 5%; display:flex; justify-content: space-between;">
                      <i class="fa fa-minus" aria-hidden="true" id="ExcluiIngressoAdult"></i>
                      <div style="width:30%">
                        <input class="form-control" type="number" name="numIngressoAdult" id="numIngressoAdult" value="0">
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <span style="padding:0;">Sênior</span><br>
                      <span>(Idade 55-90)</span>
                    </div>
                    <div class="col-md-6" style="padding-left: 12%; padding-top: 4%; display:flex; justify-content: space-between;">
                      <i class="fa fa-minus" aria-hidden="true" id="ExcluiIngressoSr"></i>
                      <div style="width:30%">
                        <input class="form-control" type="number" name="numIngressoSr" id="numIngressoSr" value="0">
                      </div>
 ...
 var selectedDate = null; // Variável para armazenar a data selecionada
  ...
  function meuCliqueAgenda(myModal) {
    ...
    var myModal = `<div class="modal-body" style="overflow-x:hidden"">
                      <div class="row">
                        <div class="col-md-5">
                          <input type="button" onclick="mostrarValor(this)" id="btnDatas" class="btn btn-primary buttonData" value="03/06/2023">
                        </div>
                          <div class="col-md-2">
                            <i class="fa fa-arrows-h" aria-hidden="true"></i>
                          </div>
                        <div class="col-md-5">
                          <input type="button" onclick="mostrarValor(this)" id="btnDatas2" class="btn btn-primary buttonData" value="04/06/2023">
                        </div>
                      </div>
                      <hr>
                      <div class="row">
                        <div class="col-md-5">
                          <input type="button" onclick="mostrarValor(this)" id="btnDatas3" class="btn btn-primary buttonData" value="10/06/2023">
                        </div>
                        <div class="col-md-2">
                          <i class="fa fa-arrows-h" aria-hidden="true"></i>
                        </div>
                        <div class="col-md-5">
                          <input type="button" onclick="mostrarValor(this)" id="btnDatas4" class="btn btn-primary buttonData" value="11/06/2023">
                        </div>
                      </div>
                      <hr>
                      <div class="row">
                        <div class="col-md-5">
                          <input type="button" onclick="mostrarValor(this)" id="btnDatas5" class="btn btn-primary buttonData" value="17/06/2023">
                        </div>
                        <div class="col-md-2">
                          <i class="fa fa-arrows-h" aria-hidden="true"></i>
                        </div>
                        <div class="col-md-5">
                          <input type="button" onclick="mostrarValor(this)" id="btnDatas6" class="btn btn-primary buttonData" value="18/06/2023">
                        </div>
                      </div>
                      <hr>
                      <div class="row">
                        <div class="col-md-5">
                          <input type="button" onclick="mostrarValor(this)" id="btnDatas7" class="btn btn-primary buttonData" value="24/06/2023">
                        </div>
                        <div class="col-md-2">
                          <i class="fa fa-arrows-h" aria-hidden="true"></i>
                        </div>
                        <div class="col-md-5">
                          <input type="button" onclick="mostrarValor(this)" id="btnDatas8" class="btn btn-primary buttonData" value="25/06/2023">
                        </div>
                      </div>
                      <hr>
                      <div class="row">
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  for (var i = 1; i <= 40; i++) {
    ...
    // Agora, a variável selectedCheckboxes contém os checkboxes selecionados
  });
...
function AjaxInsereCarrinho(GuardaTodosValor,GuardaValorKid,GuardaValorAdulto,GuardaValorIdoso,qndtTotalIngresso, checkboxValues, GuardaDate, quantidadeKid, quantidadeAdult, quantidadeSr) {
  ...
  $.ajax({
    type: 'POST',
    url: "../Ajax/AjaxInsereCarrinhoSantos.php",
    data: formdata,
    processData: false,
    contentType: false,
